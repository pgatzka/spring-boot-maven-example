...
public class Greeting extends AbstractEntity {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_greeting__id_gen")
    @SequenceGenerator(name = "seq_greeting__id_gen", sequenceName = "seq_greeting__id", allocationSize = 50)
