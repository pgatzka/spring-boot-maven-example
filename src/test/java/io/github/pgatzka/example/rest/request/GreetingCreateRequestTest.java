...
class GreetingCreateRequestTest extends BeanValidationTest<GreetingCreateRequest> {
    ...
    static Stream<Arguments> invalidCases() {
        return Stream.of(
                ...
                Arguments.of(new GreetingCreateRequest("A".repeat(50), VALID_MESSAGE, VALID_SUBJECT), Length.class,
                        "author"),
                Arguments.of(new GreetingCreateRequest(VALID_AUTHOR, "A".repeat(250), VALID_SUBJECT), Length.class,
                        "message"),
                ...
                Arguments.of(new GreetingCreateRequest(VALID_AUTHOR, VALID_MESSAGE, "A".repeat(50)), Length.class,
                        "subject"));
    }
